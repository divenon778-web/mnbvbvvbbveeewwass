                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {profile?.backgroundUrl ? (
                          ...
                          <div className="flex flex-col items-center justify-center w-full h-full p-4">
                            ...
                            <input 
                              ...
                              className="w-full bg-[#0A0A0A] border border-white/10 rounded-xl px-4 py-2 text-xs text-white focus:outline-none focus:border-emerald-500/50 transition-colors"
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="relative h-40 bg-[#0A0A0A] border border-white/10 rounded-2xl overflow-hidden group flex items-center justify-center">
                        {profile?.audioUrl ? (
                          <>
                            <div className="flex flex-col items-center justify-center w-full h-full bg-emerald-500/5">
                              <Music size={32} className="text-emerald-400 mb-3" />
                              <span className="text-xs font-bold text-emerald-400/70">Audio Linked</span>
                            </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex flex-col gap-3">
                      ...
                      <textarea 
                        ...
                        className="w-full h-32 bg-[#0A0A0A] border border-white/10 rounded-2xl p-4 text-sm text-white focus:outline-none focus:border-emerald-500/50 transition-colors resize-none"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="flex flex-col gap-3">
                        ...
                        <select 
                          ...
                          className="w-full bg-[#0A0A0A] border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500/50 transition-colors appearance-none"
                        >
                    ...
                    {profile?.links?.map((link: any, index: number) => (
                      ...
                      >
                        <input 
                          ...
                          placeholder="Title"
                          className="w-1/3 bg-[#0A0A0A] border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500/50"
                        />
                        <input 
                          type="text" 
                          value={link.url}
                          ...
                          placeholder="URL"
                          className="flex-1 bg-[#0A0A0A] border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500/50"
                        />
                        <button 
                          onClick={() => {
